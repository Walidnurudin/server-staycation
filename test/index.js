...
describe("API TESTING ENDPOINT", () => {
    ...
    it("GET Detail Page", (done) => {
        chai.request(app).get("/api/v1/member/detail-page/5e96cbe292b97300fc902228").end((err, res) => {
            expect(err).to.be.null;
            expect(res).to.have.status(200);
            expect(res.body).to.be.an('Object');
    ...
    it("POST Booking Page", (done) => {
        ...
        const dataSample = {
            image,
            idItem: "5e96cbe292b97300fc902228",
            duration: 2,
            bookingStartDate: "9-4-2020",
            bookingEndDate: "11-4-2020",
            firstName: "walid",
            lastName: "nurudin",
            email: "walidnurudin@gmail.com",
